...
![Dashboard Demo](https://img.shields.io/badge/Dashboard-Interactive-orange?style=for-the-badge)
![Data Sources](https://img.shields.io/badge/Data-4%20Sources-blue?style=for-the-badge)
...
- ✅ Power plant capacity data (6,800+ plants globally)
- ✅ Transmission network capacity (GTD database)
- ✅ PLN's RUPTL projection (2025-2034)
- ✅ Actual data center consumption (PLN West Java, 2024-2025)
- ✅ Cascading failure simulation (learning from Sumatra blackout 2026)
...
| **RUPTL PLN** | Power plant capacity projection 2025-2034 | Official PLN |
...
| **Geospatial** | ![GeoPandas](https://img.shields.io/badge/GeoPandas-0.14+-darkgreen?logo=geopandas) ![Folium](https://img.shields.io/badge/Folium-0.15+-green) |
...
```
Analysis Steps:
Data Filtering - Extract Indonesia-specific data from global databases
Validation - Cross-reference with official PLN data (RUPTL)
Gap Analysis - Project supply vs demand (2025-2030)
Cascading Simulation - Model chain reaction failures (based on Sumatra 2026 event)
Financial Impact - Calculate losses per blackout scenario
Dashboard - Build interactive visualization with Streamlit
📈 Key Findings
Finding	Detail
...
1	On-site BESS 2,000 MWh (4-hour operation)	US
 50-100M
...
© 2026 Burhanudin Badiuzaman - Portfolio Project Energy 2026